    ...
    <LandingSellBox>
      <LandingSellbox1>
        <div className="p-10">
          ...
          <CustomList
            ...
            items={[
              ...
              'Guía para implementar el conteo de carbohidratos en tu dieta',
              'Algoritmo del Dr. Dansinger para reducir la dependencia a los Fármacos',
              'Recomendación para la limpieza del organismo',
              'Guia completa de carbohidratos por alimentos (gramos, indice glucemico y raciones de HC)',
            ]}
          />
        </div>
        ...
        <button
          ...
          >
            <a href="https://gum.co/PvUfh">Comprar Ahora</a>
          </button>
        </div>
      </LandingSellbox1>
      ...
      <LandingSellbox2>
        <div className="p-10">
          ...
          <CustomList
            ...
            items={[
              ...
              'Cálculo de aporte de carbohidratos por comida',
              '​GRATIS: Guía de Planificación de Comidas para Personas con Diabetes',
              'Preguntas Frecuentes sobre alimentación para la diabetes',
              'Guía para implementar el conteo de carbohidratos en tu dieta',
              'Algoritmo del Dr. Dansinger para reducir la dependencia a los Fármacos',
              'Recomendación para la limpieza del organismo',
        ...
        <button
            className="bg-gradient-to-b from-yellow-300 to-yellow-600 hover:from-yellow-700 px-4 py-2 capitalized rounded-full text-black font-bold"
          >
            <a href="https://gum.co/kjOLI">Comprar Ahora</a>
          </button>
        </div>
      </LandingSellbox2>
    </LandingSellBox>
